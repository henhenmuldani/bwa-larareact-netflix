...
export default function Sidebar() {
    return (
        <aside className="fixed z-50 h-full w-75">
            <div className="border-gray-[#F1F1F1] flex h-full flex-col overflow-y-auto border-r p-7.5 pr-0">
                <a href="/">
                ...
                <div className="links mt-15 flex h-full flex-col gap-12.5">
                    ...
                    <div>
                        <div className="side-link mb-4 text-gray-1">Others</div>
                        <Link href={subscriptionPlan()} className="side-link">
                            <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                    ...
                    <div className="mt-auto pr-7.5">
                        <div className="rounded-[25px] bg-white p-5 outline-1 outline-[#f1f1f1]">
                            ...
                            <div className="h-1.5 w-full rounded-full bg-[#f1f1f1]">
                                <div className="h-full w-2/12 rounded-full bg-alerange"></div>
                            </div>
                        </div>
                    </div>
                </div>
